...
$(window).on('scroll', function () {
    if ($(window).scrollTop() > 70) { // Set position from top to add class
        ...
        $('.navbar .navbar-brand> img').attr('src', 'assets/site/images/logo-preto.png');
        $('.navbar .navbar-brand.green_logo> img').attr('src', 'assets/site/images/logo-green-dark.png');
        $('.navbar .navbar-brand.pink_logo> img').attr('src', 'assets/site/images/logo-pink-dark.png');
        $('.navbar .navbar-brand.orange_logo> img').attr('src', 'assets/site/images/logo-orange-dark.png');
        $('.navbar .navbar-brand.orange_logo_rtl> img').attr('src', 'assets/site/images/logo-arabic-dark.png');
        $('.navbar .navbar-brand.yellow_logo_crypto> img').attr('src', 'assets/site/images/logo_dark_crypto.png');
        $('.navbar .navbar-brand.yellow_logo> img').attr('src', 'assets/site/images/logo-yellow-dark.png');

        $('.index-light .navbar .navbar-brand> img').attr('src', 'assets/site/images/logo-dark.png');
        $('.index-light .navbar .navbar-brand.green_logo> img').attr('src', 'assets/site/images/logo-green-dark.png');
        $('.index-light .navbar .navbar-brand.yellow_logo> img').attr('src', 'assets/site/images/logo-yellow-dark.png');
        $('.index-light .navbar .navbar-brand.pink_logo> img').attr('src', 'assets/site/images/logo-pink-dark.png');
        $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', 'assets/site/images/logo-orange-dark.png');

        $('.active-navbar .navbar .navbar-brand> img').attr('src', 'assets/site/images/logo-dark.png');
        $('.active-navbar .navbar .navbar-brand.green_logo> img').attr('src', 'assets/site/images/logo-green-dark.png');
        $('.active-navbar .navbar .navbar-brand.pink_logo> img').attr('src', 'assets/site/images/logo-pink-dark.png');
        $('.active-navbar .navbar .navbar-brand.orange_logo> img').attr('src', 'assets/site/images/logo-orange-dark.png');
        $('.active-navbar .navbar .navbar-brand.yellow_logo> img').attr('src', 'assets/site/images/logo-yellow-dark.png');
        ...
        $('.navbar .navbar-brand> img').attr('src', 'assets/site/images/logo.png');
        $('.navbar .navbar-brand.green_logo> img').attr('src', 'assets/site/images/logo-green.png');
        $('.navbar .navbar-brand.pink_logo> img').attr('src', 'assets/site/images/logo-pink.png');
        $('.navbar .navbar-brand.orange_logo> img').attr('src', 'assets/site/images/logo-orange.png');
        $('.navbar .navbar-brand.orange_logo_rtl> img').attr('src', 'assets/site/images/logo-arabic-light.png');
        $('.navbar .navbar-brand.yellow_logo_crypto> img').attr('src', 'assets/site/images/logo_crypto.png');
        $('.navbar .navbar-brand.yellow_logo> img').attr('src', 'assets/site/images/logo-yellow.png');
...
$("#submit_btn").click(function() {
    ...
    if (proceed) {
        ...
        post_data = { 'userName': user_name, 'userEmail': user_email, 'userMessage': user_message, 'userPhone': user_phone };
...
tpj(document).ready(function() {
    if(tpj("#rev_slider_2_1").revolution == undefined){
        ...
        revapi2 = tpj("#rev_slider_2_1").show().revolution({
            sliderType:"standard",
            jsFileLocation:"//localhost/rev_slider/revslider/public/assets/site/js/",
            sliderLayout:"fullscreen",
            dottedOverlay:"none",
            delay:9000,
            navigation: {
